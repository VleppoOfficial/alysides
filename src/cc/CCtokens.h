...
std::string CreateToken(int64_t txfee, int64_t assetsupply, std::string name, std::string description, double ownerperc, uint8_t tokentype, uint256 assettokenid, int64_t expiryTimeSec, std::vector<uint8_t> nonfungibleData);
